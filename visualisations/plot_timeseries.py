...
def get_timeseries_combined_plot_with_conf_intervals(measure="H_1", N=2000):
...
def plot_timeseries_with_media_categories(measure="zipf_clauset", measure_name="- Zipf exponent", annotate=True, categories = ["nf", "fic", "news", "mag"], N=2000):
	...
	plt.savefig("images/coha_categories_timeseries_{}_N_{}.tiff".format(measure, N), dpi=300)

	plt.show()


if __name__=="__main__":
	plot_timeseries_with_media_categories(N=2000)
